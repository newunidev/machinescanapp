...
const ItemCountScan = sequelize.define('ItemCountScan', {
  item_count_scan_id: {
...
// Associate ItemCountScan with Category and Item
ItemCountScan.belongsTo(Category, { foreignKey: 'category_id' });
ItemCountScan.belongsTo(Item, { foreignKey: 'item_id' });

module.exports = ItemCountScan;
